...
stdenv.mkDerivation rec {
  pname = "godot";
  version = "4.2.0-beta"; # Synced to master in 2023-Nov-08
  commitHash = "3e7f638d7b574785f521beafaf52a6ad95be016f";

  src = fetchFromGitHub {
    owner = "godotengine";
    repo = "godot";
    rev = commitHash;
    hash = "sha256-o9OcCDRbJymrkvFZC/3Gjwwid/oDdC7tzsDd/PVgTY8=";
  };

    ...
    (
      ...
      let
        ...
        generic =
          ...
          let
            ...
            nameToplevel =
              "godot_" + (prev.lib.replaceStrings [ "." ] [ "_" ] majorMinorVersion) + "_" + versionStatus;
          in
          # shortHash = builtins.substring 0 7 hash;
          {
            "${nameToplevel}" = self.godot_4.overrideAttrs (oa: {
      ...
      (
        ...
        // (mergeGenericAttrs [
          ...
          #   majorMinorVersion = "4.2";
          #   versionStatus = "rc2";
          #   commit = "1ba920fada9efc8c4476ded50fe673b8db541366";
          #   hash = "sha256-wd1BNrgmuAj1zj+qQqIbQ244TdwkZrBdGcbBJzodxnc";
          #   exportTemplatesHash = "sha256-055/I9zPp0x/+KCi9a8yYyS2y+9a6R9STxClGnWylAE=";
          # }
          # {
          #   majorMinorVersion = "4.2";
          #   versionStatus = "rc1";

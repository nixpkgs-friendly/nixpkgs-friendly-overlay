...
in rec {
  godot_4_2_2-rc2 = let commit = "c61a68614e5b030a4a1e11abaa5a893b8017f78d";
  in prev.godot_4.overrideAttrs (oa: rec {
  ...
  godot_4_2_2-rc2-export-templates = prev.fetchzip {
    ...
    extension = "zip";
    url =
      "https://github.com/godotengine/godot-builds/releases/download/4.2.2-rc2/Godot_v4.2.2-rc2_export_templates.tpz";
    hash = "sha256-Cb5s2u3zCEKqKqBDbt5T8ONXPosuDsrT1SCtaZX/Zfk=";
  };
  godot_4-export-templates = pickLatest (godot_4_2_2-rc2-export-templates)
    (prev.godot_4-export-templates or null);

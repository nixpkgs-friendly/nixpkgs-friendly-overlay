...
, at-spi2-core, qt5, channel ? "stable", version ? "23.5.1.750-1"
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://repo.yandex.ru/yandex-browser/deb/pool/main/y/yandex-browser-${channel}/yandex-browser-${channel}_${version}_amd64.deb";
    inherit hash;
  };
  ...
  installPhase = let whenBeta = lib.optionalString (channel == "beta") "-beta";
  in ''

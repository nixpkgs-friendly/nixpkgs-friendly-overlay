{ pkgs, config, lib, stdenv, callPackage, fetchurl, ... }@args:
...
in {
  darkreader = buildFirefoxXpiAddon rec {
    ...
    url =
      "https://addons.mozilla.org/firefox/downloads/file/4223104/darkreader-${version}.xpi";
  ...
  "enhancer-for-youtube" = buildFirefoxXpiAddon rec {
    ...
    url =
      "https://addons.mozilla.org/firefox/downloads/file/4225147/youtube_enhancer_vc-${version}.xpi";
  ...
  "startpage-private-search" = buildFirefoxXpiAddon rec {
    ...
    url =
      "https://addons.mozilla.org/firefox/downloads/file/3421533/startpage_private_search-${version}.xpi";
